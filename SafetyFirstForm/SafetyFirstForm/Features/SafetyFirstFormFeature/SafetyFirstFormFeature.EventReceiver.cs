    ...
    public class SafetyFirstFormFeatureEventReceiver : SPFeatureReceiver
    {
        ...
        public override void FeatureActivated(SPFeatureReceiverProperties properties)
        {
            ...
            if (oWeb != null)
            {
                ...
                topNav.AddAsLast(new SPNavigationNode("Safety First Form", "Lists/Safety%20First%20Report/AllItems.aspx"));
            }
        }
        // ("Safety First Form", "_layouts/15/start.aspx#/Lists/Safety%20First%20Report/AllItems.aspx"));
        ...
        public override void FeatureDeactivating(SPFeatureReceiverProperties properties)
        {
            ...
            if (oWeb != null)
            {
                ...
                {
                    if (topNav[i].Url.Contains("Safety First"))
                    {
                        topNav[i].Delete();
                    }
                }
